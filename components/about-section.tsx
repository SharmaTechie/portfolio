              ...
              <Card className="bg-black/30 border-blue-900/50 backdrop-blur-sm">
                <CardContent className="p-4 flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-white">Krishna Sharma</div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-black/30 border-blue-900/50 backdrop-blur-sm">
                <CardContent className="p-4 flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-white">20 Years</div>
                  </div>
                </CardContent>
              </Card>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div className="relative pl-8 border-l-2 border-blue-500 pb-6">
                ...
                <h4 className="text-white text-lg font-medium">Research Paper on Neuroscience of Virtual Reality</h4>
                <p className="text-gray-400">IEEE Conference on Virtual Reality & Cognitive Science</p>
                <p className="text-gray-300 mt-2">
                    Presented my research on the impact of virtual reality on cognitive functions and neural activity at the IEEE Conference.
                    The paper, which explores how immersive VR experiences influence memory retention, brain patterns, and emotional responses, was published in the conference proceedings.
                </p>
              </div>
            </div>
          </motion.div>
